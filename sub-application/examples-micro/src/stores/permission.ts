...
import { DEMO_PRESETS } from '@micro/constants/permissionPresets'
import { PERM_WILDCARD } from '@micro/constants/perms'
import { ROLE_ADMIN } from '@micro/constants/roles'
import { canAccessMatched } from '@micro/utils/routeAccess'

const STORAGE_KEY = 'admin-permission'
const LEGACY_KEY = 'admin-demo-roles'

/** 须与主应用 `admin/src/stores/permission.ts` 中 `ADMIN_PERMISSION_SYNC_EVENT` 一致 */
